    ...
    <section id="workshops" className="py-20 bg-[#FDF8F5]">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid gap-8 md:gap-10 md:grid-cols-3">
          ...
          <article className="bg-white rounded-3xl border border-[#E4D8CF] shadow-[0_18px_60px_rgba(0,0,0,0.04)] px-6 py-7 md:px-7 md:py-8 flex flex-col">
            <div className="mb-4">
              <span
            ...
            <div className="grid gap-6 md:grid-cols-2 mb-6">
              <div>
                <h4
                  className="text-xs tracking-[0.22em] uppercase mb-2 text-[#7E6E61]"
                  style={{ fontFamily: 'Inter, sans-serif' }}
                >
                  Inhalt
                </h4>
                <ul
                  className="space-y-1.5 text-sm text-[#3A3129]"
                  style={{ fontFamily: 'Inter, sans-serif' }}
                >
