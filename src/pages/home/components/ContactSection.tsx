          ...
          <div className="space-y-6">
            ...
            >
              <li className="flex items-start gap-2">
                ...
                <span>Russian Manicure, Modellage, Nail Art, Tooth Gems &amp; Workshops möglich.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-[6px] h-1.5 w-1.5 rounded-full bg-[#C9B8B0]" />
                <span>Je genauer deine Angaben, desto besser können wir Zeit &amp; Design einplanen.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-[6px] h-1.5 w-1.5 rounded-full bg-[#C9B8B0]" />
                <span>Antwort erfolgt in der Regel zeitnah mit Terminvorschlägen.</span>
              </li>
            </ul>
