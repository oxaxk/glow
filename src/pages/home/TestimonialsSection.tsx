      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((testimonial, index) => (
            <article
              key={index}
              className="flex flex-col h-full rounded-3xl bg-white/90 border border-[#F1E2D7] shadow-[0_18px_45px_rgba(72,54,38,0.06)] px-6 py-6 md:px-7 md:py-7 hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(72,54,38,0.12)] transition-all duration-300 text-center md:text-left"
            >
              <div className="flex flex-col items-center gap-3 mb-4 md:flex-row md:items-start md:gap-4">
                <div className="w-11 h-11 rounded-full overflow-hidden bg-[#F3D9D0]/80 flex items-center justify-center text-sm font-semibold text-[#5A4036] mb-1 md:mb-0">
                  {testimonial.image ? (
                    <img
